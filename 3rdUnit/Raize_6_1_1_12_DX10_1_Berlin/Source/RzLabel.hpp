...
// (DO NOT EDIT: machine generated header) 'RzLabel.pas' rev: 30.00 (Windows)
...
protected:
	...
	System::Types::TPoint __fastcall CalcCenterPoint(void);
	System::Types::TPoint __fastcall CalcRadius(void);
	...
	virtual Vcl::Stdctrls::TTextLayout __fastcall GetLayout(void);
