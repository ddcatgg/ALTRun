...
// (DO NOT EDIT: machine generated header) 'RzDlgBtn.pas' rev: 30.00 (Windows)
...
protected:
	...
	virtual System::Uitypes::TColor __fastcall GetHotTrackColor(void);
	...
	virtual System::Uitypes::TColor __fastcall GetHighlightColor(void);
