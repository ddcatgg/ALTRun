...
// (DO NOT EDIT: machine generated header) 'RzRadChk.pas' rev: 30.00 (Windows)
...
protected:
	...
	virtual void __fastcall UpdateGlyphDimensions(void) = 0 ;
...
protected:
	...
	virtual void __fastcall UpdateGlyphDimensions(void);
