...
// (DO NOT EDIT: machine generated header) 'RzIntLst.pas' rev: 30.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EOutOfRange(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High) : System::Sysutils::EListError(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EOutOfRange(NativeUInt Ident, System::TVarRec const *Args, const int Args_High)/* overload */ : System::Sysutils::EListError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOutOfRange(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High)/* overload */ : System::Sysutils::EListError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOutOfRange(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High, int AHelpContext) : System::Sysutils::EListError(Msg, Args, Args_High, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EOutOfRange(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::EListError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EOutOfRange(NativeUInt Ident, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::EListError(Ident, Args, Args_High, AHelpContext) { }
