...
// (DO NOT EDIT: machine generated header) 'RzEdit.pas' rev: 30.00 (Windows)
...
public:
	/* TMouseTrackControlStyleHook.Destroy */ inline __fastcall virtual ~TRzEditStyleHook(void) { }
...
protected:
	HIDESBASE Vcl::Controls::TCaption __fastcall GetText(void);
...
protected:
	...
	virtual bool __fastcall StoreDate(void);
	...
	virtual bool __fastcall StoreTime(void);
