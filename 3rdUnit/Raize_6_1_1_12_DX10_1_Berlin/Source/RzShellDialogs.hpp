...
// (DO NOT EDIT: machine generated header) 'RzShellDialogs.pas' rev: 30.00 (Windows)
...
public:
	__fastcall TRzSelectFolderButtonCaptions(void);
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TRzSelectFolderButtonCaptions(void) { }
...
protected:
	...
	virtual Vcl::Forms::TCustomForm* __fastcall CreateForm(void);
