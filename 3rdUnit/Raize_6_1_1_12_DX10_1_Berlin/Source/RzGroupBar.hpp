...
// (DO NOT EDIT: machine generated header) 'RzGroupBar.pas' rev: 30.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ERzGroupBarError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ERzGroupBarError(NativeUInt Ident, System::TVarRec const *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ERzGroupBarError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ERzGroupBarError(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ERzGroupBarError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ERzGroupBarError(NativeUInt Ident, System::TVarRec const *Args, const int Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
protected:
	...
	System::Types::TPoint __fastcall CursorPosition(void);
...
public:
	...
	Vcl::Imglist::TCustomImageList* __fastcall SmallImageList(void);
	Vcl::Imglist::TCustomImageList* __fastcall LargeImageList(void);
	Vcl::Imglist::TCustomImageList* __fastcall CaptionImageList(void);
	virtual void __fastcall InitiateAction(void);
...
protected:
	...
	virtual void __fastcall Paint(void);
	DYNAMIC void __fastcall Resize(void);
	virtual System::Types::TRect __fastcall GetControlExtents(void);
