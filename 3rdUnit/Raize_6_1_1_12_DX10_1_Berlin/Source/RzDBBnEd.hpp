...
// (DO NOT EDIT: machine generated header) 'RzDBBnEd.pas' rev: 30.00 (Windows)
...
protected:
	...
	virtual Vcl::Graphics::TBitmap* __fastcall GetAltBtnGlyph(void);
	virtual void __fastcall SetAltBtnGlyph(Vcl::Graphics::TBitmap* Value);
	virtual Vcl::Graphics::TBitmap* __fastcall GetButtonGlyph(void);
