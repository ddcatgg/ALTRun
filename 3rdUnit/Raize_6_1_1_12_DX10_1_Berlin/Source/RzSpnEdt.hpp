...
// (DO NOT EDIT: machine generated header) 'RzSpnEdt.pas' rev: 30.00 (Windows)
...
protected:
	...
	virtual Vcl::Graphics::TBitmap* __fastcall GetUpRightGlyph(void);
	virtual void __fastcall SetUpRightGlyph(Vcl::Graphics::TBitmap* Value);
	virtual Vcl::Graphics::TBitmap* __fastcall GetDownLeftGlyph(void);
	virtual void __fastcall SetDownLeftGlyph(Vcl::Graphics::TBitmap* Value);
	virtual Vcl::Buttons::TNumGlyphs __fastcall GetUpRightNumGlyphs(void);
	virtual void __fastcall SetUpRightNumGlyphs(Vcl::Buttons::TNumGlyphs Value);
	virtual Vcl::Buttons::TNumGlyphs __fastcall GetDownLeftNumGlyphs(void);
...
protected:
	...
	virtual Vcl::Graphics::TBitmap* __fastcall GetButtonUpGlyph(void);
	virtual void __fastcall SetButtonUpGlyph(Vcl::Graphics::TBitmap* Value);
	virtual Vcl::Buttons::TNumGlyphs __fastcall GetButtonUpNumGlyphs(void);
	virtual void __fastcall SetButtonUpNumGlyphs(Vcl::Buttons::TNumGlyphs Value);
	virtual Vcl::Graphics::TBitmap* __fastcall GetButtonDownGlyph(void);
	virtual void __fastcall SetButtonDownGlyph(Vcl::Graphics::TBitmap* Value);
	virtual Vcl::Buttons::TNumGlyphs __fastcall GetButtonDownNumGlyphs(void);
