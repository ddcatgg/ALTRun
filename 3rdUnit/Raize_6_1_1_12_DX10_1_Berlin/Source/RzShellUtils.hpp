...
// (DO NOT EDIT: machine generated header) 'RzShellUtils.pas' rev: 30.00 (Windows)
...
public:
	Winapi::Shlobj::PItemIDList operator[](int Index) { return Item[Index]; }
...
public:
	Winapi::Shlobj::PItemIDList operator[](int index) { return PIDLs[index]; }
