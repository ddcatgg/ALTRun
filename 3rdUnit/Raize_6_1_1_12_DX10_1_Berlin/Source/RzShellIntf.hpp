...
// (DO NOT EDIT: machine generated header) 'RzShellIntf.pas' rev: 30.00 (Windows)
...
public:
	virtual HRESULT __stdcall DragEnter(IDataObject_NRC* dataObj, int grfKeyState, const System::Types::TPoint pt, int &dwEffect) = 0 ;
	virtual HRESULT __stdcall DragOver(int grfKeyState, const System::Types::TPoint pt, int &dwEffect) = 0 ;
	virtual HRESULT __stdcall DragLeave(void) = 0 ;
	virtual HRESULT __stdcall Drop(IDataObject_NRC* dataObj_NRC, int grfKeyState, const System::Types::TPoint pt, int &dwEffect) = 0 ;
public:
