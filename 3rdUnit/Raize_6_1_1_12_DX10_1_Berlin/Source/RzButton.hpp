...
// (DO NOT EDIT: machine generated header) 'RzButton.pas' rev: 30.00 (Windows)
...
protected:
	...
	virtual System::Types::TRect __fastcall GetHotTrackRect(void);
...
protected:
	...
	virtual System::Types::TRect __fastcall GetCaptionRect(void);
...
protected:
	...
	virtual System::Types::TPoint __fastcall GetImageSize(void);
	virtual System::Types::TRect __fastcall GetCaptionRect(void);
	virtual System::Types::TRect __fastcall GetGlyphRect(void);
	...
	virtual Vcl::Buttons::TBitBtnKind __fastcall GetKind(void);
...
public:
	...
	__fastcall virtual ~TRzToolbarButton(void);
...
public:
	/* TRzToolbarButton.Destroy */ inline __fastcall virtual ~TRzMenuToolbarButton(void) { }
...
public:
	...
	Vcl::Imglist::TCustomImageList* __fastcall ImageList(void);
	Vcl::Imglist::TCustomImageList* __fastcall DisabledImageList(void);
	DYNAMIC void __fastcall Click(void);
