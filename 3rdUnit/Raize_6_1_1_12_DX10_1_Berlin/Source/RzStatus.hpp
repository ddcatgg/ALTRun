...
// (DO NOT EDIT: machine generated header) 'RzStatus.pas' rev: 30.00 (Windows)
...
protected:
	...
	System::Uitypes::TColor __fastcall GetDisabledFontColor(void);
...
protected:
	...
	virtual System::Types::TRect __fastcall GetCaptionRect(void);
	virtual int __fastcall GetMinWidth(void);
	System::Types::TPoint __fastcall GetImageSize(void);
	virtual void __fastcall Paint(void);
