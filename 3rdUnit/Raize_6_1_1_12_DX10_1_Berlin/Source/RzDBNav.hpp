...
// (DO NOT EDIT: machine generated header) 'RzDBNav.pas' rev: 30.00 (Windows)
...
protected:
	...
	virtual System::Uitypes::TColor __fastcall GetButtonSelectionColorStart(void);
	virtual void __fastcall SetButtonSelectionColorStart(System::Uitypes::TColor Value);
	virtual System::Uitypes::TColor __fastcall GetButtonSelectionColorStop(void);
	virtual void __fastcall SetButtonSelectionColorStop(System::Uitypes::TColor Value);
	virtual System::Uitypes::TColor __fastcall GetButtonSelectionFrameColor(void);
	...
	virtual System::Classes::TStrings* __fastcall GetHints(void);
