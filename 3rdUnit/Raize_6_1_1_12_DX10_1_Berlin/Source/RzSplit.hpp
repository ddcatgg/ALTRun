...
// (DO NOT EDIT: machine generated header) 'RzSplit.pas' rev: 30.00 (Windows)
...
protected:
	...
	Vcl::Controls::TBorderWidth __fastcall GetBorderWidth(void);
	...
	System::Uitypes::TColor __fastcall GetFlatColor(void);
	...
	Vcl::Controls::TPadding* __fastcall GetPadding(void);
...
public:
	/* TObject.Create */ inline __fastcall TRzPaneData(void) : System::Classes::TPersistent() { }
...
protected:
	...
	virtual void __fastcall MouseDownSetFocus(void);
...
protected:
	...
	virtual void __fastcall Paint(void);
	virtual System::Types::TRect __fastcall GetParentWorkingRect(void);
	virtual void __fastcall CheckPosition(int &Value);
	virtual bool __fastcall HotSpotTopBottom(void);
	DYNAMIC Vcl::Controls::_di_IDockManager __fastcall CreateDockManager(void);
	virtual void __fastcall MouseDownSetFocus(void);
	DYNAMIC void __fastcall MouseDown(System::Uitypes::TMouseButton Button, System::Classes::TShiftState Shift, int X, int Y);
	DYNAMIC void __fastcall MouseMove(System::Classes::TShiftState Shift, int X, int Y);
	DYNAMIC void __fastcall MouseUp(System::Uitypes::TMouseButton Button, System::Classes::TShiftState Shift, int X, int Y);
	DYNAMIC void __fastcall KeyDown(System::Word &Key, System::Classes::TShiftState Shift);
	DYNAMIC void __fastcall HotSpotClick(void);
	virtual Vcl::Controls::TAlign __fastcall GetAlign(void);
	...
	virtual System::Types::TRect __fastcall GetSizeBarRect(void);
