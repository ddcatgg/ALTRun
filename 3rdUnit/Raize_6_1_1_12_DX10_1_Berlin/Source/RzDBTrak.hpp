...
// (DO NOT EDIT: machine generated header) 'RzDBTrak.pas' rev: 30.00 (Windows)
...
public:
	/* TStringList.Create */ inline __fastcall TRzTrackValueList(void)/* overload */ : System::Classes::TStringList() { }
