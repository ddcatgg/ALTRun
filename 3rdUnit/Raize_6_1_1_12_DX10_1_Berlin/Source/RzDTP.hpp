...
// (DO NOT EDIT: machine generated header) 'RzDTP.pas' rev: 30.00 (Windows)
...
protected:
	...
	virtual System::Types::TRect __fastcall GetEditRect _DEPRECATED_ATTRIBUTE0 (void);
	virtual System::UnicodeString __fastcall GetRightJustifiedText _DEPRECATED_ATTRIBUTE0 (void);
...
public:
	...
	__fastcall virtual ~TRzDateTimePicker _DEPRECATED_ATTRIBUTE0 (void);
