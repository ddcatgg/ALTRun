...
// (DO NOT EDIT: machine generated header) 'RzShellCtrls.pas' rev: 30.00 (Windows)
...
protected:
	...
	Winapi::Shlobj::PItemIDList __fastcall GetIdList(void);
...
public:
	/* TObject.Create */ inline __fastcall TRzShellLocator(void) : System::Classes::TPersistent() { }
...
protected:
	...
	Vcl::Comctrls::TTreeNode* __fastcall GetFirstRootLevelShellNode(void);
...
public:
	...
	DYNAMIC void __fastcall RefreshNodes(void)/* overload */;
...
private:
	...
	void *FData;
	Winapi::Shlobj::PItemIDList __fastcall GetAbsPidl(void);
...
private:
	...
	Winapi::Shlobj::PItemIDList __fastcall GetAbsoluteIdList(void);
	unsigned __fastcall GetAttributes(void);
	bool __fastcall GetEditable(void);
